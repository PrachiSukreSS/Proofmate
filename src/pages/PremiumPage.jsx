  ...
  const premiumFeatures = [
    {
      ...
      description:
        "Experience blazing-fast recording start times and seamless playback",
    },
    {
      icon: Shield,
      title: "Advanced Security",
      description:
        "End-to-end encryption and secure cloud storage for your recordings",
    },
    {
      icon: Cloud,
      title: "Unlimited Storage",
      description:
        "Never worry about running out of space for your important recordings",
    },
    {
      icon: Headphones,
      title: "AI Transcription",
      description:
        "Automatically convert your voice recordings to searchable text",
    },
  ];
    ...
    <div className="max-w-6xl mx-auto space-y-12">
      ...
      <div className="text-center space-y-6">
        <div className="flex items-center justify-center gap-3">
          ...
          <h1
            className="text-4xl md:text-5xl font-bold bg-gradient-to-r from-amber-500 to-orange-600 bg-clip-text text-transparent"
            style={{
        ...
        <p className="text-xl text-slate-700 max-w-2xl mx-auto">
          Supercharge your recording experience with advanced features and
      ...
      <div className="text-center space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 text-left">
          ...
          <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 border-2 border-purple-200">
            ...
            <p className="text-slate-600">
              Yes, all recordings are encrypted and stored securely in the
              cloud.
            </p>
          </div>
        </div>
